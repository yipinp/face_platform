...
int main() {
    face_api face_app;
    string image_file("/home/pyp/face_app/face_platform/images/liuyifei_0.jpeg");
    face_app.set_input_source("");
    ...
    //face_app.insert_face_to_database("YangMi",face_app.face_id_out[0]);
